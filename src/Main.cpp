...
int main(int argCount, char** args) {
  ...
  Problem::Linear2D p;
  {
    ...
    p.example_beam_dyn(8.0, 1.0, 32, 5, 200, 1e-8);
  }
  ...
  MyFem::Vis::Visualization2D vis("p", 1600, 1000, 1.0/p.deltaT_, sf::Color(200,200,200), sf::Color(200,200,0), sf::Color(0,0,0), timesNewRoman, 12, 100, pShared, 2, false, 1.0);
