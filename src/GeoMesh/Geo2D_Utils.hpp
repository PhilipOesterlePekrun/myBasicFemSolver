...
*/
inline double lAngle(Array<Vectord/*2*/>/*2*/ l1, Array<Vectord/*2*/>/*2*/ l2) {
  double angle1 = ::Utils::Math::CommonFunctions::atan2(l1(1)(1) - l1(0)(1), l1(1)(0) - l1(0)(0));
  
  double angle2 = ::Utils::Math::CommonFunctions::atan2(l2(1)(1) - l2(0)(1), l2(1)(0) - l2(0)(0));
...
*/
inline double lAngle(Array<Vectord/*2*/>/*3*/ l) {
  double angle10 = ::Utils::Math::CommonFunctions::atan2(l(0)(1) - l(1)(1), l(0)(0) - l(1)(0));
  
  double angle12 = ::Utils::Math::CommonFunctions::atan2(l(2)(1) - l(1)(1), l(2)(0) - l(1)(0));
